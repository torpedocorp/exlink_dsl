...
public class DefaultWriteDBMapItemAdaptor extends AbstractPostMapItemAdaptor{
	
	public static Logger logger = LoggerFactory.getLogger(DefaultWriteDBMapItemAdaptor.class);
	
	private static HashMap<String ,String> sqlMap = new HashMap<String ,String>();

	public DefaultWriteDBMapItemAdaptor() {
