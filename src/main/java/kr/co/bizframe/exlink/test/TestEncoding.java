...
//		System.out.println("utf-8 -> euc-kr        : " + new String(word.getBytes(), "euc-kr"));
//		System.out.println("utf-8 -> ksc5601       : " + new String(word.getBytes(), "ksc5601"));
//		System.out.println("utf-8 -> x-windows-949 : " + new String(word.getBytes(), "x-windows-949"));
//		System.out.println("utf-8 -> iso-8859-1    : " + new String(word.getBytes(), "iso-8859-1"));
