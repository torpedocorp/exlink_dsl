...
import kr.co.bizframe.exlink.parser.online.plugin.CareqJsonOnlineGenerator;
...
public class TestRestInsertDayCalClientPost {

	public static Logger logger = LoggerFactory.getLogger(TestRestInsertDayCalClientPost.class);
	...
	public ArrayList<LinkedHashMap<String, Object>> getCareqList(String tname) throws ExlinkDslException{
		...
		String runSql = parser.getQuery("select * from " +tname +" where rownum < 101 ");
	...
	public static void main(String[] args) {
		...
		try {
			...
			TestRestInsertDayCalClientPost test = new TestRestInsertDayCalClientPost();
			test.getTargetList();
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	public void doRequest(LinkedHashMap<String, Object> sendData) {
		...
		try {
			...
			URL url = new URL("http://dev.torpedo.co.kr:38888/exlink/ca");
